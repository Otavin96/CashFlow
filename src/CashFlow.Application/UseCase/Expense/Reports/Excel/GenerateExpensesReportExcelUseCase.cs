...
public class GenerateExpensesReportExcelUseCase : IGenerateExpensesReportExcelUseCase
{
    ...
    private XLCellValue ConvertPaymentType(Domain.Enums.PaymentType paymentType)
    {
        return paymentType switch
        {
            Domain.Enums.PaymentType.Cash => "Dinheiro",
            Domain.Enums.PaymentType.CreditCard => "Cartão de Credito",
            Domain.Enums.PaymentType.DebitCard => "Carão de Débito",
            Domain.Enums.PaymentType.ElectronicTransfer => "Transferencia Bancaria",
            _ => string.Empty
        };
    }
